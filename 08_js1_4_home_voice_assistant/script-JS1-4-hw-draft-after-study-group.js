...
function getReply(command) {
    ...
    let commandInWords = command.toLowerCase().split(' ');
    // console.log(commandInWords);     
    // ----> every command (except pure numbers) logs like this: 
    ...
    if (command.includes('calendar')) {
        ...
        let myEventLabel = commandInWords.slice(1, -3);  // console.log(`This shows myEventLabel to be pushed: ${myEventLabel}`);         
        // ---> bike,ride,the,3,/,5,/,2019    // 0 1 2 3 4 5 6 7 
        let myEventLabelJoined = commandInWords.slice(1, -3).join(' ');  
        // console.log(`This shows myEventLabelJoined to be pushed: ${myEventLabelJoined}`);   // ---> works ok
        ...
        myCalendar.push(myEventLabelJoined);  // 
        myCalendar.push(myEventObject);       // 
    ...
    if (command === 'What am I doing this week ?') {
        ...
        console.log(`Today is ${dayNumber} of ${monthWritten} ${year}. Total number of events: ${myCalendar.length}.`);
        console.log(` --> Here's your calendar content:`);
        return myCalendar;
    }
    ...
    for (let i = 0; i <= commandInWords.length - 1; i++) {
        ...
        if (commandInWords.includes('timer')) {
            ...
            // first I will have to convert '4' into number 4, otherwise n calculation is possible 
            // ---> https://gomakethings.com/converting-strings-to-numbers-with-vanilla-javascript/
            let minutesToSetStr = commandInWords[3];
            // console.log(minutesToSetStr); console.log(typeof (minutesToSetStr)); // ---> '4' ---> STRING    :(
            let minutesToSetNr = parseInt(minutesToSetStr);
            // console.log(minutesToSetNr); console.log(typeof (minutesToSetNr));   // --->  4  ---> NUMBER    :)

            // https://www.w3schools.com/jsref/met_win_settimeout.asp   but it needs minutes in milliseconds as a parameter ... so --->
            let minutesToSetNrInMili = minutesToSetNr * 60000
            // because 1 minute === 60000 milliseconds   
            // console.log(minutesToSetNrInMili); // ---> 240000  <---  4 minutes  * 60000
            ...
            return (`Your timer is set to ${minutesToSetNr} minutes).`); // just to log something meaningful :>
...
console.log(`---> INPUT --> 'nameList'`); console.log(nameList); 
// ---> works: it shows the names inside the nameList array :)

console.log(`---> INPUT --> 'hello my name is Magda'`); console.log(getReply('hello my name is Magda')); 
// Should 1. save the name magda 2. respond with "nice to meet you magda"     // What if someone writes this twice?  
console.log(`---> INPUT --> 'hello my name is Magda'`); console.log(getReply('hello my name is Magda')); 
// I NEED TO FIX THIS AND PREVENT THE NAME FROM BEING ADDED TO nameList ARRAY! 
console.log(`---> INPUT --> 'Hi my name is Mohammed'`); console.log(getReply('Hi my name is Mohammed')); 
// btw UPPER CASE and it wooorks 

console.log(`---> INPUT --> 'nameList'`); console.log(nameList); 
// ---> works: it shows the names inside the nameList array :)
console.log(`---> INPUT --> 'What is my name'`); console.log(getReply('What is my name'));   
//should respond with the name of the person.  //What if the name has not yet been mentioned?

console.log(`---> INPUT --> 'Add fishing to my todo'`); console.log(getReply('Add fishing to my todo'));   
// adds fishing to my to do and responds as required 
console.log(`---> INPUT --> 'Add singing in the shower to my todo'`); console.log(getReply('Add singing in the shower to my todo'));   
// as above
console.log(`---> INPUT --> 'Add coding in my sleep to my todo'`); console.log(getReply('Add coding in my sleep to my todo'));   
// as above
console.log(`---> INPUT --> 'What is on my todo'`); console.log(getReply('What is on my todo')); // works

console.log(`---> INPUT --> 'Remove fishing from my todo'`); console.log(getReply('Remove fishing from my todo'));   
// removes the item from the to do list and responds as required
console.log(`---> INPUT --> 'What is on my todo'`); console.log(getReply('What is on my todo'));   
// works because it doesn't show the removed item anymore 

console.log(`---> INPUT --> 'What day is it today?'`); console.log(getReply('What day is it today?'));   
// Should respond with the date in a human readable format. eg. if today is 30/8/2019 then it should respond with 30. of August 2019
console.log(`---> INPUT --> 'What is love'`); console.log(getReply('What is love')); 
// Baby don't hurt me LINK :>  This is the extra command we were supposed to add ;>

console.log(`---> INPUT --> 'My favorite dish is lasagne'`); console.log(getReply('My favorite dish is lasagne'));   
//  saves the user's favorite dish as lasagne on the favourite dish list
console.log(`---> INPUT --> 'What is my favorite dish'`); console.log(getReply('What is my favorite dish')); 
// responds with the favorite dish

console.log(`---> INPUT --> 1 * 8 + 1 <--`);  
...
console.log(`---> INPUT --> 'Set timer for 4 minutes'`); console.log(getReply('Set timer for 4 minutes'));  
// Should respond with "Timer set for 4 minutes".When 4 minutes is up: "Timer done".  

console.log(`---> INPUT --> 'Add Bike ride the 3 / 5 / 2019 to my calendar'`); console.log(getReply('Add Bike ride the 3 / 5 / 2019 to my calendar'));  
//Should respond with "Bike ride added to your calendar".   Should add an event represented by an object with keys name and date to an array of events.

console.log(`---> INPUT --> 'What am I doing this week ?'`); console.log(getReply('What am I doing this week ?'));  
// should respond with the events for that week.Fx "This week you have 1 event: Bike ride the 3. of May 2019"