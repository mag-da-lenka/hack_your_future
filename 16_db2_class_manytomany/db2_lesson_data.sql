-- CREATE DATABASE db2_lesson_data;  <--- why it's commented out:
-- if you first create a database you don't add the command in the file that already exists! 
-- you simple paste the contents of the data base :>
